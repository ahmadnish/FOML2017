...
To avoid such a problems, probabilities should be calculated using functions that result in a [0, 1] interval. For logistic regression, logisitic sigmoid functions is used in lecture notes:
\begin{align}
	\sigma(t) = \frac{1}{1 + \exp(-t)}
\end{align}
The distinct property of such a function is that it outputs result exactly between 0 and 1, as we asked for
